...
namespace Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // System.Console.WriteLine(Arrays.zeroThruNine());
            // System.Console.WriteLine(Arrays.names());
            // System.Console.WriteLine(Arrays.trueFalse());
            // System.Console.WriteLine(Lists.flavors());
            Array customers = Arrays.names();
            var flavors = Lists.flavors();
            Dictionaries.favIceCream(customers, flavors);
        }
    }
}
