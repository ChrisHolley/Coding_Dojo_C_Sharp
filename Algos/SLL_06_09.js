...
// myStack.head = new SLNode(5);
// myStack.head.next = new SLNode(6);
// myStack.head.next.next = new SLNode(7);
// myStack.addToBack(99).addToBack(12);
// myStack.addToFront(25).addToFront(45);
// myStack.addToFront(333);
// myStack.removeFromFront();
// myStack.printList();
// console.log(myStack.contains(333));
// console.log(myStack.removeNode(6))
myStack.printList();